  ...
  return (
    <div className="min-h-screen bg-background" style={{ background: "linear-gradient(to bottom, hsl(var(--background)), hsl(var(--background)))" }}>
      ...
      <style>{`
        ...
        .cs-contact-bar { width: 5px; height: 52px; background: #002966 !important; border-radius: 3px; flex-shrink: 0; box-shadow: 0 0 16px rgba(0,41,102,0.95), 0 0 32px rgba(0,41,102,0.7), 0 0 48px rgba(0,41,102,0.4); }
        .cs-contact-title { font-family: 'Montserrat', 'Inter', Arial, system-ui, sans-serif !important; font-size: 52px !important; font-weight: 900 !important; line-height: 1.05 !important; letter-spacing: -0.025em !important; color: #000000 !important; text-transform: uppercase !important; margin: 0 !important; -webkit-text-fill-color: #000000 !important; background: none !important; -webkit-background-clip: unset !important; background-clip: unset !important; text-shadow: none !important; opacity: 1 !important; }
