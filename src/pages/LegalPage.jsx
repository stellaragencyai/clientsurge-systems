...
const content = {
  privacy: {
    ...
    body: [
      ...
      { heading: "Contact Us", text: "If you have any questions about this Privacy Policy, please contact us at nolan@clientsurgesystems.com." },
    ],
  },
  terms: {
    ...
    body: [
      ...
      { heading: "Contact Us", text: "For questions about these Terms, contact us at nolan@clientsurgesystems.com." },
    ],
  },
  cookies: {
    title: "Cookie Policy",
    ...
    body: [
      ...
      { heading: "Contact Us", text: "For questions about our cookie use, contact us at nolan@clientsurgesystems.com." },
    ],
  },
};
...
export default function LegalPage() {
  ...
  const renderSectionText = (text) => {
    if (!text.includes("nolan@clientsurgesystems.com")) {
      return text;
    }

    const [before, after] = text.split("nolan@clientsurgesystems.com");
    return (
      <>
        {before}
        <a href="mailto:nolan@clientsurgesystems.com" className="text-primary font-medium hover:underline">
