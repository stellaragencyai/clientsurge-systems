          ...
          <div className="rounded-xl border border-border bg-white shadow-sm p-6 md:p-8">
            ...
            {step === 1 && (
              <div className="space-y-6">
                ...
                {selectionLabel && (
                  <div className="rounded-xl border-2 border-primary bg-primary/5 px-5 py-4 flex items-center gap-4">
                    <div className="w-10 h-10 rounded-full bg-primary flex items-center justify-center flex-shrink-0">
                      <CheckCircle2 className="w-5 h-5 text-white" />
                    </div>
                    <div>
                      <p className="text-xs font-bold uppercase tracking-widest text-primary mb-0.5">Selected Plan</p>
                      <p className="text-base font-bold text-foreground">{selectionLabel}</p>
                      <p className="text-xs text-muted-foreground mt-0.5">Continue below to complete your setup intake</p>
                    </div>
                  </div>
                )}
