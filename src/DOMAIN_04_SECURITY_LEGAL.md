...
| 224 | ✅ | Add consent_given_at + consent_ip fields to WebsiteLead entity - duplicate of #88/#89; WebsiteLead schema and submitLeadCapture/webhookLeadCapture writes are present | C | — | → B (#89) | 🧵 Consent-Capture | Done |
