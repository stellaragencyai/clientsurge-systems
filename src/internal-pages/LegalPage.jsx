...
<p>If you provide a phone number or email address and opt in where required, we may use it to send requested follow-ups, appointment reminders, booking confirmations, missed-call text-back messages, review requests, customer reactivation messages, service updates, and related business communications. Message frequency varies. Message and data rates may apply. Consent is not a condition of purchase. You can opt out of SMS by replying STOP, and you can contact us to update communication preferences.</p>
<h2>4. Consent Records</h2>
<p>When you submit a form or otherwise opt in to communications, we may store consent records such as consent text version, timestamp, IP address, source page, UTM/source details, and submitted contact details so we can maintain accurate compliance and audit records.</p>
<h2>5. AI and Automation Processing</h2>
...
<h2>7. Data Sharing and Third-Party Services</h2>
