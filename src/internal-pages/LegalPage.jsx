...
const TERMS_SECTIONS = [
  ...
  },
  {
    ...
    body: "You are responsible for providing accurate business information, timely access to required accounts (website CMS, CRM, phone system, email platform, booking calendar, analytics, or other tools), and any approvals needed for configuration. Delays in providing access or information may delay setup and launch. You are responsible for maintaining the security of your own accounts and credentials.",
  },
  {
    id: "acceptable-use",
    number: "8",
    title: "Acceptable Use",
    body: "You agree not to use ClientSurge services for unlawful, abusive, or fraudulent purposes, including sending unsolicited messages, violating consent requirements, impersonating other businesses, or using the platform to harm others. Violation may result in immediate suspension or termination of services without refund.",
  },
  {
    id: "no-guarantee",
    number: "9",
    title: "No Guarantee of Specific Results",
    body: "ClientSurge Systems provides automation infrastructure, workflow configuration, and support services. We do not guarantee specific revenue results, lead conversion rates, booking volumes, or business outcomes. Results depend on your offer, market, traffic, sales process, industry, and execution.",
  },
  {
    id: "liability",
    number: "10",
