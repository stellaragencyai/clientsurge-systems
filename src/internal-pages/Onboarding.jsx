...
const LEAD_SOURCES = ["Website Forms", "Instagram DMs", "Phone Calls", "Paid Ads", "Referrals", "Walk-ins"];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30 flex flex-col">
      ...
      <div className="h-1 bg-slate-200">
        <div
          ...
          style={{ width: `${((step) / STEPS.length) * 100}%`, background: "linear-gradient(90deg,#00AEEF,#003B8F)" }}
        />
      </div>
          ...
          <div className="bg-white rounded-3xl shadow-xl border border-slate-100 p-8">
            ...
            {step === 4 && (
              <StepWrapper title="Almost done!" subtitle="A few final details to complete your setup">
                <Field label="What are the most common questions clients ask?" hint="We'll train your AI to answer these automatically">
          ...
          <button
            ...
            className={`px-3.5 py-2 rounded-xl text-sm font-semibold border-2 transition-all ${
              active
                ...
                : "border-slate-200 bg-slate-50 text-slate-500 hover:border-primary/40 hover:text-slate-700"
            }`}
          >
            {opt}
          </button>
