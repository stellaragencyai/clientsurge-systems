...
const WhyUsCard = ({ reason }) => {
  ...
  return (
    <div className="group p-6 rounded-2xl bg-card border border-border hover:border-primary/50 hover:shadow-lg transition-all duration-300 cursor-default">
      <div className="w-10 h-10 rounded-xl bg-primary/10 border border-primary/20 flex items-center justify-center mb-5 group-hover:bg-primary/20 transition-colors duration-300">
        ...
        <div className="flex items-center justify-center gap-2 mb-14 flex-wrap">
          {["Day 1: Kickoff call", "Days 2–4: Build & integrate", "Day 5–7: Test & launch", "Day 30+: Optimize"].map((step, i) => (
            <div key={i} className="flex items-center gap-2">
              <span className="px-4 py-1.5 bg-primary/8 border border-primary/20 rounded-full text-xs font-semibold text-primary">
                {step}
              </span>
