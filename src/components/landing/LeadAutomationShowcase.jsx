...
const workflowItems = [
  ...
  },
  {
    ...
    icon: PhoneCall,
    accent: "rgba(0,106,163,0.92)",
    glow: "rgba(0,106,163,0.26)",
  },
  {
    id: "followup",
    label: "Follow-Up",
...
function BenefitItem({ item, active, onFocus }) {
  ...
  return (
    <button
      ...
      className="lead-showcase-benefit group w-full rounded-lg border px-5 py-4 text-left transition-all duration-300"
      style={{
        background: active
          ? "linear-gradient(135deg, rgba(255,255,255,0.96) 0%, rgba(238,248,255,0.94) 100%)"
          : "linear-gradient(135deg, rgba(255,255,255,0.78) 0%, rgba(241,248,255,0.82) 100%)",
        borderColor: active ? "rgba(0,174,239,0.34)" : "rgba(0,174,239,0.14)",
        boxShadow: active
          ? "0 18px 36px rgba(0,88,160,0.12), inset 0 1px 0 rgba(255,255,255,0.65)"
          : "0 8px 22px rgba(0,59,143,0.06), inset 0 1px 0 rgba(255,255,255,0.55)",
      }}
    >
      <div className="flex items-start gap-4">
        <div
          className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-lg border transition-all duration-300"
          style={{
            background: active ? "rgba(0,174,239,0.16)" : "rgba(0,174,239,0.08)",
            borderColor: active ? "rgba(0,174,239,0.28)" : "rgba(0,174,239,0.14)",
          }}
        >
          <Icon className="h-[18px] w-[18px]" style={{ color: "#006AA3" }} />
        </div>
        <div className="min-w-0">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span
              ...
              style={{
                background: active ? "rgba(0,174,239,0.12)" : "rgba(0,174,239,0.06)",
                borderColor: active ? "rgba(0,174,239,0.22)" : "rgba(0,174,239,0.12)",
                color: "#006AA3",
              }}
            >
              {item.metric}
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: active
            ? "linear-gradient(155deg, rgba(255,255,255,0.98) 0%, rgba(238,248,255,0.96) 100%)"
            : "linear-gradient(155deg, rgba(255,255,255,0.92) 0%, rgba(241,248,255,0.88) 100%)",
          borderColor: active ? "rgba(0,174,239,0.34)" : "rgba(0,174,239,0.16)",
          boxShadow: expanded
            ? active
              ? `0 24px 55px rgba(0, 59, 143, 0.16), 0 0 0 1px rgba(255,255,255,0.45), 0 0 26px ${item.glow}`
              : "0 20px 48px rgba(0, 59, 143, 0.12), 0 0 0 1px rgba(255,255,255,0.4)"
      ...
      >
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-2">
            <div
              ...
              style={{
                background: active ? "rgba(0,174,239,0.14)" : "rgba(0,174,239,0.08)",
                borderColor: "rgba(0,174,239,0.14)",
              }}
            >
              <Icon className="h-4 w-4" style={{ color: "#006AA3" }} />
            </div>
            <div>
        ...
        <div className="mt-3 flex items-center justify-between">
          ...
          <span
            className="inline-flex items-center rounded-full border px-2.5 py-1 text-[10px] font-bold uppercase tracking-[0.18em]"
            style={{
              background: active ? "rgba(16,185,129,0.14)" : "rgba(0,174,239,0.07)",
              borderColor: active ? "rgba(16,185,129,0.2)" : "rgba(0,174,239,0.14)",
              color: active ? "#047857" : "#006AA3",
            }}
          >
            Live
          </span>
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 70% 55% at 18% 24%, rgba(0,174,239,0.12) 0%, transparent 62%), radial-gradient(ellipse 52% 45% at 80% 20%, rgba(0,59,143,0.08) 0%, transparent 60%), linear-gradient(180deg, rgba(248,251,255,0.94) 0%, rgba(241,248,255,0.96) 54%, rgba(255,255,255,0.98) 100%)",
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at center, rgba(0,174,239,0.16) 0%, rgba(0,59,143,0.08) 48%, transparent 75%)",
        }}
      />
      ...
      <div className="relative mx-auto max-w-6xl">
        <div className="mb-8 flex flex-col items-center justify-center">
          <div
            ...
            style={{
              background: "linear-gradient(180deg, rgba(255,255,255,0.92) 0%, rgba(241,248,255,0.88) 100%)",
              borderColor: "rgba(0,174,239,0.16)",
              boxShadow: focusPulse
                ? "0 0 0 6px rgba(0,174,239,0.08), 0 16px 40px rgba(0,59,143,0.12)"
                : "0 10px 28px rgba(0,59,143,0.08)",
            }}
          >
            <span
              aria-hidden="true"
        ...
        <div
          className={`rounded-xl border px-6 py-8 shadow-[0_24px_70px_rgba(0,59,143,0.08)] md:px-10 md:py-10 ${focusPulse ? "lead-showcase-shell-active" : ""}`}
          style={{
            background: "linear-gradient(180deg, rgba(255,255,255,0.86) 0%, rgba(241,248,255,0.76) 100%)",
            borderColor: "rgba(0,174,239,0.16)",
        ...
        >
                ...
                {outcomeStats.map((item) => (
                  <div
                    ...
                    style={{
                      ...
                      borderColor: "rgba(0,174,239,0.14)",
                      boxShadow: "0 10px 26px rgba(0,59,143,0.06)",
                    }}
                  >
            ...
            <div className="relative">
              <div className="lead-showcase-stage relative mx-auto aspect-[1.04/1] w-full max-w-[620px] overflow-visible">
                ...
                <div
                  ...
                  style={{
                    background:
                      "radial-gradient(circle at center, rgba(0,174,239,0.18) 0%, rgba(0,59,143,0.08) 40%, transparent 76%)",
                ...
                >
                  ...
                  >
                    <div
                      ...
                      style={{
                      background:
                          "radial-gradient(circle at 16% 16%, rgba(0,174,239,0.08) 0%, transparent 30%), radial-gradient(circle at 80% 18%, rgba(16,185,129,0.08) 0%, transparent 26%), linear-gradient(180deg, rgba(255,255,255,0.74) 0%, rgba(238,248,255,0.5) 100%)",
                      }}
                    />

                    <div className="relative z-10 flex h-full flex-col">
                      <div className="flex items-center justify-between border-b border-[rgba(0,174,239,0.1)] px-[7%] py-[5%]">
                        <div>
                      ...
                      <div className="relative flex-1">
                        <div className="absolute inset-0 px-[7%] py-[7%]">
                          <div className="grid h-full grid-rows-[auto_auto_1fr] gap-[5%]">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                              <div className="rounded-[16px] border border-[rgba(0,174,239,0.1)] bg-white/65 px-3 py-3">
                            ...
                            <div className="rounded-[20px] border border-[rgba(0,174,239,0.1)] bg-white/55 px-4 py-3">
                              <p className="text-[0.48rem] font-bold uppercase tracking-[0.22em] text-foreground/45">
                                Follow-Up Status
                              </p>
                              <div className="mt-3 space-y-2.5">
                                {workflowItems.map((item) => (
                                  <div
                                    key={`before-${item.id}`}
                                    className="flex items-center justify-between rounded-[14px] border border-[rgba(0,174,239,0.08)] bg-[rgba(255,255,255,0.72)] px-3 py-2"
                                  >
                        ...
                        <div
                          className="absolute inset-y-0 right-0 overflow-hidden border-l border-[rgba(0,174,239,0.08)] transition-[width,opacity]"
                          style={{
                                ...
                                return (
                                  <div
                                    ...
                                    style={{
                                      ...
                                      borderColor: active ? "rgba(0,174,239,0.2)" : "rgba(0,174,239,0.1)",
                                  ...
                                  >
                                    <div className="flex items-start justify-between gap-2">
                                      ...
                                      <span
                                        ...
                                        style={{
                                          background: active ? `${item.glow}` : "rgba(0,174,239,0.08)",
                                          color: active ? "#006AA3" : "rgba(0,88,160,0.82)",
                                        }}
                                      >
                                        Live
                                      </span>
          ...
          <div
            ...
            style={{
              background: "linear-gradient(180deg, rgba(255,255,255,0.84) 0%, rgba(241,248,255,0.9) 100%)",
              borderColor: "rgba(0,174,239,0.14)",
              boxShadow: "0 18px 42px rgba(0,59,143,0.08), inset 0 1px 0 rgba(255,255,255,0.52)",
            }}
          >
                ...
                {workflowItems.map((item) => {
                  ...
                  return (
                    <button
                      ...
                      style={{
                        background: active
                          ? "linear-gradient(135deg, rgba(0,174,239,0.14) 0%, rgba(102,217,255,0.22) 100%)"
                          : "rgba(255,255,255,0.78)",
                        borderColor: active ? "rgba(0,174,239,0.24)" : "rgba(0,174,239,0.12)",
                        color: active ? "#006AA3" : "rgba(5,42,74,0.78)",
                        boxShadow: active ? "0 12px 24px rgba(0,88,160,0.08)" : "none",
                      }}
                    >
                      {item.label}
                    </button>
            ...
            <button
              ...
              style={{
                background: "linear-gradient(135deg, #003B8F 0%, #0088CC 52%, #00AEEF 100%)",
                boxShadow: "0 16px 32px rgba(0,88,160,0.22)",
              }}
            >
              Book Your Demo
      ...
      <style>{`
        .lead-showcase-appointments {
          ...
          font-style: italic;
          font-weight: 600;
          background: linear-gradient(135deg, #003B8F 0%, #0088CC 45%, #00AEEF 100%);
        ...
        .lead-showcase-cta:hover {
          ...
          box-shadow: 0 18px 36px rgba(0,88,160,0.3);
        }
        ...
        @keyframes leadShowcaseShellFocus {
          ...
          45% {
            ...
            box-shadow: 0 0 0 10px rgba(0,174,239,0.08), 0 30px 80px rgba(0,59,143,0.12);
          }
          100% {
            transform: translateY(0) scale(1);
            box-shadow: 0 24px 70px rgba(0,59,143,0.08);
          }
        }
