        ...
        >
          ...
          >
            ...
            >
              ...
              />
              <img
                src="https://media.base44.com/images/public/69dc4a79656fdba136d413d3/712d5fd6b_Gemini_Generated_Image_1lk62g1lk62g1lk6.png"
                alt="ClientSurge Systems"
                fetchpriority="high"
                decoding="async"
                style={{ position: "relative", zIndex: 1, height: "clamp(32px, 4vw, 42px)", width: "auto", objectFit: "contain", mixBlendMode: "multiply", filter: "contrast(1.05)" }}
              />
            </span>
