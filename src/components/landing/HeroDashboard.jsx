...
const PIPELINE = [
  ...
  { label: "Contacted", count: 18, color: "#0088CC", bg: "rgba(0,136,204,0.1)",   bar: 0.72 },
...
const RECENT_LEADS = [
  ...
  { name: "Marcus D.",  source: "Google Ad", status: "Contacted", time: "7m ago",  dot: "#0088CC" },
    ...
    >
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "10px", marginBottom: "10px" }}>
        {[
          ...
          { label: "AI Replied",     val: replied,  suffix: "%",  color: "#0088CC", icon: "⚡" },
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px", marginBottom: "10px" }}>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "10px" }}>
            <div style={{ width: "24px", height: "24px", borderRadius: "50%", background: "linear-gradient(135deg,#0088CC,#00AEEF)", display: "flex", alignItems: "center", justifyContent: "center" }}>
