    ...
    <section className="relative py-16 md:py-24 overflow-hidden" style={{ background: "#ffffff" }}>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
            ...
            return (
              ...
              >
                ...
                <div className="mt-4 pt-3 border-t border-gray-100">
                  <p className="font-titles font-black text-red-600" style={{ fontSize: "1.3rem", lineHeight: 1 }}>{leak.impactValue}</p>
        ...
        <motion.div
          ...
          style={{ background: "linear-gradient(135deg, #FEF2F2 0%, #FFF7ED 100%)", border: "1px solid rgba(239, 68, 68, 0.2)" }}
        >
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div>
              <p className="text-xs font-bold uppercase tracking-wider text-red-600 mb-1">Cumulative Revenue Leak</p>
              <p className="font-titles font-black text-red-700" style={{ fontSize: "clamp(1.5rem, 3vw, 2.25rem)", lineHeight: 1 }}>
                $2,000 – $15,000+
              </p>
              <p className="text-sm text-red-500 mt-1">per month for a typical service business with 50+ leads</p>
            </div>
            <div className="flex flex-col items-center md:items-end">
              <div className="flex items-end gap-1 h-12">
                {[20, 40, 60, 80, 100].map((h, i) => (
                  <div key={i} className="rounded-t" style={{ width: "8px", height: `${h}%`, background: `rgba(220, 38, 38, ${0.3 + i * 0.15})` }} />
                ))}
              </div>
              <p className="text-[10px] text-red-400 mt-1">Growing every hour</p>
            </div>
          </div>
        </motion.div>
