    ...
    style={{
      ...
      <div className="relative flex justify-center items-center h-16">
        ...
        <div
          ...
          style={{
            background: "linear-gradient(90deg, transparent 0%, rgba(0,136,204,0.18) 20%, rgba(0,136,204,0.28) 50%, rgba(0,136,204,0.18) 80%, transparent 100%)",
        ...
        <div
          ...
          style={{
            background: "radial-gradient(circle, #0077B6 0%, rgba(0,136,204,0.5) 70%)",
            boxShadow: "0 0 16px rgba(0,136,204,0.6), 0 0 32px rgba(0,174,239,0.3)",
