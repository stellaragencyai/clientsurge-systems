    ...
    <section id="build-stack" className="bg-white pt-16 md:pt-20 pb-20 md:pb-28 px-6 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto text-center mt-4 relative z-10">
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <Link to="/pricing" onClick={() => trackCTA("compare_packages", "final_cta")} className="cs-btn-primary focus:outline-none focus:ring-2 focus:ring-primary rounded-lg" style={{ padding: "0 40px", height: "56px", fontSize: "1rem" }}>
            Compare Packages <ArrowRight className="w-5 h-5" />
          </Link>
          <Link to="/store" onClick={() => trackCTA("browse_automation_store", "final_cta")} className="inline-flex items-center justify-center h-14 px-6 rounded-lg border-2 border-primary/30 bg-white text-sm font-semibold text-primary hover:bg-primary/10 hover:border-primary/50 transition-all duration-200">
            Browse Automation Store
          </Link>
          <Link to="/book" onClick={() => trackCTA("guided_system_match", "final_cta")} className="inline-flex items-center justify-center h-14 px-6 rounded-lg border border-border bg-white text-sm font-semibold text-foreground hover:bg-primary/5 transition-all duration-200">
            Get Help Choosing
          </Link>
        </div>
