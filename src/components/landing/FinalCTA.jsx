  ...
  return (
    <section id="book-demo" className="py-24 md:py-32 px-6 bg-gradient-to-b from-card/80 via-background to-background">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="mt-10">
          <button onClick={() => navigate("/start")} className="shiny-brown-btn-fc inline-block" style={{borderRadius:"9999px",padding:"2px",background:"linear-gradient(135deg,#a0714f 0%,#c8965c 30%,#f5d9a8 50%,#c8965c 70%,#7a4f2e 100%)",boxShadow:"0 4px 18px rgba(120,70,20,0.35)",transition:"box-shadow 0.3s ease, transform 0.3s ease",border:"none",cursor:"pointer"}}>
