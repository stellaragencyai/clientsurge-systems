...
export default function FinalCTA() {
  return (
    <section id="book-demo" className="py-24 md:py-32 px-6 bg-foreground">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="mt-6 text-background/60 text-lg max-w-xl mx-auto leading-relaxed">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-x-8 gap-y-2 text-sm text-background/40">
