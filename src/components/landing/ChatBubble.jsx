      ...
      {open && (
        <div
          ...
          style={{
            ...
            background:
              "linear-gradient(white, white) padding-box, linear-gradient(135deg,#0088CC,#00AEEF,#DDF4FF,#00AEEF,#005B99) border-box",
        ...
        >
          ...
          <div
            ...
            style={{ background: "linear-gradient(135deg,#005B99 0%,#0077B6 60%,#00AEEF 100%)" }}
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <p className="text-blue-200/80 text-[11px]">Online · Typically replies instantly</p>
                </div>
              </div>
            </div>
            <button
            ...
            {messages.map((msg, i) => (
              <div key={i} className={`flex ${msg.role === "user" ? "justify-end" : "justify-start"}`}>
                ...
                <div
                  ...
                  style={
                    msg.role === "user"
                      ? { background: "linear-gradient(135deg,#005B99,#0077B6)" }
            ...
            <div className="px-4 pb-3 flex flex-wrap gap-2" style={{ background: "hsl(40,30%,98%)" }}>
              {QUICK_QUESTIONS.map((q) => (
                <button
                  ...
                  onMouseEnter={(e) => (e.currentTarget.style.background = "rgba(0,136,204,0.12)")}
                  onMouseLeave={(e) => (e.currentTarget.style.background = "rgba(0,136,204,0.06)")}
                >
                  {q}
                </button>
              ))}
          ...
          <div
            ...
            style={{ background: "rgba(0,136,204,0.05)", borderTop: "1px solid rgba(0,136,204,0.1)" }}
          >
