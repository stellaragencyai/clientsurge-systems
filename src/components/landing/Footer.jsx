  ...
  return (
    <footer className="cs-footer">
      ...
      <style>{`
        ...
        .cs-footer-contact-card { min-width: 0; display: grid; grid-template-columns: auto minmax(0, 1fr) auto; align-items: center; gap: 12px; padding: 15px; border-radius: 18px; border: 1px solid rgba(0, 174, 239, 0.18); background: rgba(255, 255, 255, 0.72); box-shadow: 0 10px 30px rgba(15, 23, 42, 0.06), inset 0 1px 0 rgba(255,255,255,.9); backdrop-filter: blur(14px); -webkit-backdrop-filter: blur(14px); transition: transform .22s ease, border-color .22s ease, box-shadow .22s ease, background .22s ease; }
        ...
        .cs-footer-contact-icon { width: 38px; height: 38px; display: inline-flex; align-items: center; justify-content: center; border-radius: 12px; color: #006bb0; background: linear-gradient(145deg, rgba(0,174,239,.14), rgba(0,59,143,.08)); border: 1px solid rgba(0,174,239,.16); }
        ...
        .cs-footer-contact-card:hover .cs-footer-contact-arrow { color: #006bb0; transform: translateX(3px); }
        ...
        .cs-footer-nav-column a::after { content: ""; position: absolute; left: 0; right: 100%; bottom: 3px; height: 1px; background: linear-gradient(90deg, #00AEEF, #003B8F); transition: right .24s ease; }
        ...
        .cs-footer-nav-column a:hover { color: #006bb0; transform: translateX(3px); }
        ...
        .cs-footer-legal a:hover { color: #006bb0; }
        ...
        .cs-footer-status-item svg { width: 13px; height: 13px; color: #006bb0; }
        .cs-footer-top-button { width: 38px; height: 38px; display: inline-flex; align-items: center; justify-content: center; border-radius: 999px; border: 1px solid rgba(0,174,239,.24) !important; color: #075985 !important; background: rgba(255,255,255,.72) !important; box-shadow: 0 6px 18px rgba(15,23,42,.06); transition: transform .2s ease, box-shadow .2s ease, background .2s ease; }
