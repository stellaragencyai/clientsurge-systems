    ...
    <footer className="cs-footer">
      ...
      <style>{`
        .cs-footer {
          ...
          overflow: hidden;
          background:
            radial-gradient(circle at 18% 34%, rgba(0, 212, 255, 0.09), transparent 28%),
        ...
        .cs-footer a:focus-visible, .cs-footer button:focus-visible { outline: 2px solid #00D4FF; outline-offset: 3px; box-shadow: 0 0 0 4px rgba(0, 212, 255, 0.18); }
        .cs-footer-accent { height: 3px; background: linear-gradient(90deg, transparent 0%, #00D4FF 25%, #00D4FF 50%, #002D62 75%, transparent 100%); box-shadow: 0 0 18px rgba(0, 212, 255, 0.45); }
        .cs-footer-inner { width: min(100% - 48px, 1180px); margin: 0 auto; }
        .cs-footer-system { background: linear-gradient(135deg, #002D62 0%, #0047AB 52%, #00D4FF 100%); padding: 34px 0; }
        ...
        .cs-footer-system-cta { display: inline-flex; align-items: center; justify-content: center; min-height: 44px; padding: 0 24px; border-radius: 999px; background: #ffffff; border: 1px solid #ffffff; color: #002D62 !important; -webkit-text-fill-color: #002D62 !important; font-size: 14px; font-weight: 800; white-space: nowrap; transition: transform 0.2s ease, box-shadow 0.2s ease; box-shadow: 0 4px 16px rgba(0,0,0,0.15); }
        ...
        .cs-footer-brand-glow { position: absolute; width: 280px; height: 180px; top: -52px; left: -48px; pointer-events: none; background: radial-gradient(circle, rgba(0, 212, 255, 0.16), transparent 68%); filter: blur(12px); }
        ...
        .cs-footer-contact-card { min-width: 0; display: grid; grid-template-columns: auto minmax(0, 1fr) auto; align-items: center; gap: 12px; padding: 15px; border-radius: 12px; border: 1px solid rgba(0, 212, 255, 0.18); background: rgba(255, 255, 255, 0.72); box-shadow: 0 10px 30px rgba(15, 23, 42, 0.06), inset 0 1px 0 rgba(255,255,255,.9); backdrop-filter: blur(14px); -webkit-backdrop-filter: blur(14px); transition: transform .22s ease, border-color .22s ease, box-shadow .22s ease, background .22s ease; }
        .cs-footer-contact-card:hover { transform: translateY(-3px); border-color: rgba(0, 212, 255, 0.45); background: rgba(255, 255, 255, 0.94); box-shadow: 0 16px 38px rgba(0, 59, 143, 0.12), inset 0 1px 0 #ffffff; }
        .cs-footer-contact-icon { width: 38px; height: 38px; display: inline-flex; align-items: center; justify-content: center; border-radius: 12px; color: #0047AB; background: linear-gradient(145deg, rgba(0,212,255,.14), rgba(0,45,98,.08)); border: 1px solid rgba(0,212,255,.16); }
        ...
        .cs-footer-contact-card:hover .cs-footer-contact-arrow { color: #0047AB; transform: translateX(3px); }
        ...
        .cs-footer-nav-column a::after { content: ""; position: absolute; left: 0; right: 100%; bottom: 3px; height: 1px; background: linear-gradient(90deg, #00D4FF, #002D62); transition: right .24s ease; }
        ...
        .cs-footer-nav-column a:hover { color: #0047AB; transform: translateX(3px); }
        ...
        .cs-footer-legal a:hover { color: #0047AB; text-decoration: underline; text-underline-offset: 3px; }
        ...
        .cs-footer-status-item svg { width: 13px; height: 13px; color: #0047AB; }
        .cs-footer-top-button { width: 38px; height: 38px; display: inline-flex; align-items: center; justify-content: center; border-radius: 999px; border: 1px solid rgba(0,212,255,.24) !important; color: #002D62 !important; background: rgba(255,255,255,.72) !important; box-shadow: 0 6px 18px rgba(15,23,42,.06); transition: transform .2s ease, box-shadow .2s ease, background .2s ease; }
        .cs-footer-top-button:hover { transform: translateY(-3px); background: #ffffff !important; box-shadow: 0 10px 24px rgba(0,45,98,.12); }
