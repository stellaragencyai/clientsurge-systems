...
export default function ServiceCardTimeline({ serviceKey, currentStage }) {
  ...
  const colors = ["#0077B6", "#3b82f6", "#00AEEF", "#8b5cf6", "#22c55e"];
  ...
  return (
    <div style={{
      ...
      <p style={{ fontSize: "11px", fontWeight: "700", color: "#0077B6", margin: "0 0 12px", textTransform: "uppercase", letterSpacing: "0.08em" }}>
          ...
          return (
            <div key={idx} style={{ display: "flex", alignItems: "center", gap: "10px" }}>
              <div style={{
                ...
                height: "28px",
                borderRadius: "50%",
                background: isComplete ? color : isCurrent ? `${color}20` : "rgba(0,136,204,0.08)",
              ...
              <span style={{
                ...
                color: isComplete ? color : isCurrent ? color : "rgba(10,22,40,0.5)",
              }}>
                {stage.label}
              </span>
            </div>
