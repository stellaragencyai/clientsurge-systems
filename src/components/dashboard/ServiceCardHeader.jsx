...
export default function ServiceCardHeader({ service }) {
  ...
  return (
    <div style={{ marginBottom: "20px", paddingBottom: "14px", borderBottom: "1px solid rgba(154,92,46,0.1)" }}>
      <div style={{ display: "flex", alignItems: "flex-start", gap: "12px", marginBottom: "10px" }}>
        <ServiceIcon serviceKey={serviceKey} size={40} />
        <div style={{ flex: 1 }}>
          <h3 style={{ fontSize: "18px", fontWeight: "800", color: "#1b140d", margin: "0 0 2px", lineHeight: 1.2 }}>
            {productName}
          </h3>
          <p style={{ fontSize: "12px", color: "rgba(27,20,13,0.6)", margin: 0, lineHeight: 1.4 }}>
            {description}
          </p>
        </div>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "12px", flexWrap: "wrap" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "12px", flexWrap: "wrap" }}>
          <span style={{ fontSize: "10px", fontWeight: "700", color: "rgba(27,20,13,0.45)", fontFamily: "monospace", background: "rgba(154,92,46,0.05)", padding: "4px 8px", borderRadius: "6px" }}>
            Order #{orderId.slice(0, 8).toUpperCase()}
          </span>
          <span style={{ fontSize: "11px", fontWeight: "600", color: "#9a5c2e", background: "rgba(154,92,46,0.08)", padding: "4px 10px", borderRadius: "6px" }}>
