  ...
  return (
    <div style={{
      ...
      {[
        ...
        <div key={label} style={{
          background: "rgba(255,255,255,0.85)", border: "1px solid rgba(154,92,46,0.12)",
          borderRadius: "16px", padding: "18px 20px",
          boxShadow: "0 2px 12px rgba(15,23,42,0.05)",
        }}>
          <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "8px" }}>
            <Icon style={{ width: "14px", height: "14px", color: "rgba(154,92,46,0.5)" }} />
            <span style={{ fontSize: "10px", fontWeight: "700", color: "rgba(27,20,13,0.45)", textTransform: "uppercase", letterSpacing: "0.1em" }}>{label}</span>
          </div>
          <p style={{ fontSize: "28px", fontWeight: "900", color, margin: "0 0 2px", lineHeight: 1 }}>{value}</p>
          <p style={{ fontSize: "11px", color: "rgba(27,20,13,0.4)", margin: 0 }}>{sub}</p>
        </div>
      ))}
    </div>
  );
