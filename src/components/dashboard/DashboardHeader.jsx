...
export default function DashboardHeader({ userEmail, activeServices, project, order }) {
  ...
  return (
    <div style={{
      ...
      boxShadow: "0 20px 60px rgba(60,25,5,0.3), 0 4px 16px rgba(0,0,0,0.1)",
      position: "relative",
      overflow: "hidden",
    }}>
      {/* Ambient glow */}
      <div style={{
        ...
        background: "radial-gradient(circle, rgba(200,150,92,0.12) 0%, transparent 70%)",
        pointerEvents: "none",
      }} />
        ...
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", flexWrap: "wrap", gap: "16px", marginBottom: "24px" }}>
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "8px" }}>
              ...
              <span style={{ fontSize: "11px", fontWeight: "700", color: "rgba(245,217,168,0.6)", letterSpacing: "0.16em", textTransform: "uppercase" }}>
                ClientSurge Systems
              </span>
            </div>
            <h1 style={{ fontSize: "clamp(22px,4vw,32px)", fontWeight: "800", color: "#ffffff", margin: "0 0 4px", lineHeight: 1.15 }}>
              Welcome back, {displayName} 👋
            </h1>
            <p style={{ fontSize: "14px", color: "rgba(245,217,168,0.65)", margin: 0 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "12px" }}>
          {[
            ...
            <div key={label} style={{
              ...
              border: "1px solid rgba(245,217,168,0.1)",
              borderRadius: "12px", padding: "14px 16px",
            }}>
              <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "6px" }}>
                <Icon style={{ width: "14px", height: "14px", color: "rgba(245,217,168,0.5)" }} />
                <span style={{ fontSize: "10px", fontWeight: "600", color: "rgba(245,217,168,0.5)", textTransform: "uppercase", letterSpacing: "0.1em" }}>{label}</span>
              </div>
