...
const SERVICE_DEFINITIONS = {
  instant_lead_response: {
    ...
    steps: [
      ...
      { id: "lead_form", section: "Lead Form", label: "Lead capture form submits to webhookLeadCapture with order-scoped credentials" },
  ...
  missed_call_text_back: {
    ...
    steps: [
      ...
      { id: "twilio_webhook", section: "Twilio", label: "Twilio Voice webhook URL set → /receiveTwilioStatusWebhook" },
  ...
  nurture_sequence_14d: {
    ...
    steps: [
      ...
      { id: "automation_schedule", section: "Configuration", label: "Operator-only nurture pilot configured and tested from Install Order Workspace" },
