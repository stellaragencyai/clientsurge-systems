    ...
    <div className="space-y-4">
      <div className="bg-amber-50 rounded-xl border border-amber-200 p-4 flex items-start gap-2">
        ...
        <p className="text-xs text-amber-800">
          <strong>Asana Completion Gate — Admin Only.</strong> Do not mark an Asana task complete unless the app data proves it. This panel does not sync to Asana — it only shows whether the task is safe to close.
        </p>
      </div>

      <div className="bg-white rounded-xl border border-gray-200 p-5" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.03)" }}>
        <h3 className="text-sm font-bold text-gray-900 mb-4">Workstream Completion Status</h3>
              ...
              <div key={i} className="rounded-lg border border-gray-100 bg-gray-50/50 p-3">
                ...
                <div className="space-y-1 text-xs">
                  ...
                  <div className="flex items-center gap-1.5 mt-1 pt-1 border-t border-gray-100">
                    <span className="font-semibold text-gray-400">Safe to mark Asana task complete?</span>
                    {allGreen ? (
