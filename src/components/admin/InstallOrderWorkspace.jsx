...
// SuggestionCard extracted to install/ServiceConfigEditor
...
// DeploymentSummaryPanel extracted to install/DeploymentSummaryPanel
    ...
    <div className={`rounded-xl border p-3 ${suggestion.available ? "border-blue-200 bg-blue-50/60" : "border-amber-200 bg-amber-50/70"}`}>
      <div className="flex items-start justify-between gap-3">
        ...
        {suggestion.available ? (
          <button type="button" onClick={onApply} className="inline-flex items-center gap-1 rounded-full border border-border bg-white px-2.5 py-1 text-[11px] font-semibold text-muted-foreground hover:border-primary hover:text-primary">
...
// ServiceConfigEditor is extracted to components/admin/install/ServiceConfigEditor
