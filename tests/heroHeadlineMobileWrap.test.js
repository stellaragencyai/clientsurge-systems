...
test("home hero headline has a narrow-phone wrap guard", () => {
  ...
  assert.match(mobileBlock, /\.landing-hero__headline \{\s*font-size: clamp\(2rem, 8\.5vw, 3\.4rem\) !important;/);
  ...
  assert.match(narrowBlock, /\.landing-hero__headline \{\s*font-size: clamp\(1\.85rem, 9vw, 2\.4rem\) !important;\s*max-width: 22rem !important;/);
