    ...
    <tr>
      ...
      <td style="padding:8px 12px;text-align:center;">
        <span style="display:inline-block;padding:2px 10px;border-radius:20px;font-size:11px;font-weight:700;
          ...
          color:${s.complete ? '#065f46' : s.inProgress ? '#005B99' : '#6b7280'};">
        ...
        <tr>
          ...
          <td style="padding:6px 12px;">
            <div style="background:#f3f4f6;border-radius:4px;height:8px;width:180px;display:inline-block;vertical-align:middle;">
              <div style="background:linear-gradient(90deg,#7a4825,#00AEEF);height:8px;border-radius:4px;width:${pct}%;"></div>
            </div>
          </td>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="background:#f9fafb;padding:32px 16px;">
        <tr><td align="center">
          <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
            ...
            <!-- Header -->
            <tr>
              <td style="background:linear-gradient(135deg,#005B99 0%,#0077B6 60%,#00AEEF 100%);padding:32px 40px;">
            ...
            <tr>
              <td style="background:#fff;padding:0 40px 32px;">
                ...
                <div style="background:#f3f4f6;border-radius:8px;height:12px;margin-bottom:8px;overflow:hidden;">
                  <div style="background:linear-gradient(90deg,#7a4825,#00AEEF);height:12px;width:${progressPct}%;border-radius:8px;"></div>
                </div>
            ...
            <tr>
              <td style="background:#f9fafb;padding:24px 40px;border-top:1px solid #e5e7eb;">
                <p style="margin:0;font-size:12px;color:#9ca3af;text-align:center;">
                  This report was automatically generated by <strong style="color:#0077B6;">ClientSurge Systems</strong>.<br>
                  Log in to your <a href="#" style="color:#0077B6;">client portal</a> for full details.
                </p>
              </td>
            </tr>
