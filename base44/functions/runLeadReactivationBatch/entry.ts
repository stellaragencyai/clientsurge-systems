...
import { executeLeadReactivationBatch } from "../_shared/canonicalAutomationRuntime.js";
...
Deno.serve(async (req) => {
  try {
    ...
    return Response.json(
      {
        error: error instanceof Error ? error.message : "Failed to run reactivation batch",
