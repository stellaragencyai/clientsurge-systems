...
// This main.ts lacks deployment observability (permission checks, execution
// logging) present in entry.ts. Do NOT edit this file expecting changes to
// take effect in production. All production changes must be made to entry.ts.
