// ⚠️ STALE DUPLICATE — entry.ts IS THE DEPLOYED SOURCE OF TRUTH.
// This main.ts is nearly identical to entry.ts but is NOT the deployed file.
// Do NOT edit this file expecting changes to take effect in production.
// All production changes must be made to entry.ts.
/**
