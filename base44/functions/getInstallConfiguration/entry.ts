      ...
      order: {
        ...
        services: remoteSetupWorkspace.services.map((serviceState) => ({
          ...
          test_summary: serviceState.test_summary || {
            ...
            latest_production_runtime_event_type: null,
            latest_production_runtime_at: null,
            latest_production_runtime_status: null,
            latest_production_success_at: null,
            latest_production_blocked_at: null,
            latest_production_failed_at: null,
            latest_test_runtime_at: null,
            latest_test_success_at: null,
            ...
            successful_production_exists: false,
          ...
          execution_profile: serviceState.execution_profile || {
            mode: "placeholder",
        ...
        subscription: buildSubscriptionSummary(linkedSubscription) || (order.subscription_id || order.stripe_subscription_id
          ? {
              ...
              billing_status: order.billing_status || order.subscription_status || "",
              current_period_start: order.current_period_start || null,
              current_period_end: order.current_period_end || null,
