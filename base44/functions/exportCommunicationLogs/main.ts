...
// Base44 currently deploys entry.ts for most functions. Keep main.ts aligned so
// manual exports and future runtime changes do not reintroduce unauthenticated
// service-role access.
